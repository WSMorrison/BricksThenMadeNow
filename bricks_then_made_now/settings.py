...
ROOT_URLCONF = 'bricks_then_made_now.urls'
...
WSGI_APPLICATION = 'bricks_then_made_now.wsgi.application'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'BricksThenMadeNow@educationalpurposes.only'
else:
